...
namespace Microsoft.AspNet.SignalR.Tests
{
    public class PersistentConnectionFacts
    {
        public class ProcessRequest
        {
            ...
            {
                var connection = new Mock<PersistentConnection>() { CallBase = true };
                Assert.Throws<InvalidOperationException>(() => connection.Object.ProcessRequest(new HostContext(new Dictionary<string, object>())));
            }
            ...
            {
                var connection = new Mock<PersistentConnection>() { CallBase = true };
                var req = new OwinRequest(new Dictionary<string, object>());
                var dr = new DefaultDependencyResolver();
                var context = new HostContext(req.Environment);
